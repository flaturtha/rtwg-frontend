      ...
      <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
        ...
        <div className="lg:w-1/2">
          <p className="text-base text-gray-700 md:text-lg">
            <em>Content is no longer king.</em> It has been overthrown in this age of instant access to any information we need ... just ask Alexa, Siri, or ... !
          </p>
          <p className="text-base text-gray-700 md:text-lg">
            Today, <strong>CONTEXT is king.</strong> Where that information appears, in what format, in relation to your business ... <em>that</em> is what matters.
          </p>
          <p className="text-base text-gray-700 md:text-lg">
            But most content, the stuff you hire a freelance writer to create, is devoid of any context. Or, more often, it is so specific to the particular context ... a blog post or a case study ... that it is unusable for any other purpose without additional effort <em>and expense</em>!
          </p>
