    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          ...
          for research once &amp; get all your content!
        </h2>
        <p className="text-base text-gray-700 md:text-lg">
          Choose the Package you need based on your specific content needs.
        </p>
      </div>
      <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
        <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center mt-2">
              <div className="mr-1 text-5xl font-bold">$7,875</div>
              <div className="text-gray-700 text-sm italic mt-2">32.7% off à la carte price &hellip; $14,500</div>
            </div>
        ...
        <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow border-deep-purple-accent-400">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center mt-2">
              <div className="mr-1 text-5xl font-bold">$9,750</div>
              <div className="text-gray-700 text-sm italic mt-2">32.7% off à la carte price &hellip; $14,500</div>
            </div>
            <div className="mt-2 space-y-3">
        ...
        <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center mt-2">
              <div className="mr-1 text-5xl font-bold">$8,280</div>
              <div className="text-gray-700 text-sm italic mt-2">28% off à la carte price &hellip; $11,500</div>
            </div>
            <div className="mt-2 space-y-3">
