export default function Blog() {
  return (
    ...
    <p className="mb-2 text-xs font-semibold tracking-wide text-gray-600 uppercase sm:text-center">
      Most Recent Post &mdash; 14 August 2021
    </p>
    <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
      ...
      <p className="text-base text-gray-700 md:text-lg">
        Writing good content is hard. Read tips and best practices for improving your <em>in house</em> content.
      </p>
    </div>
    <div className="mb-10 sm:text-center">
      <a href="/rich-cook" aria-label="Author" className="inline-block mb-1">
        <img
          alt="avatar"
          src="ME.jpg"
      ...
      <div>
        ...
        <p className="text-sm font-medium leading-4 text-gray-600">a.k.a, Rich the Writer Guy</p>
      </div>
    </div>
