...
export default function Footer() {
  return (
    <div className="relative mt-16 bg-indigo-400">
      <svg
        className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-indigo-400"
        ...
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            >
              ...
              <span className="ml-2 text-xl font-bold tracking-wide text-indigo-100 uppercase">
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <p className="font-semibold tracking-wide text-indigo-200">
                Clients
              </p>
